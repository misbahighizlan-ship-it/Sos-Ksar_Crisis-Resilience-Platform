                    ...
                    <div className="p-8 sm:p-12">
                        <div className="flex flex-col items-center mb-10 text-center">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-950/40 border border-red-500/30 text-red-200 backdrop-blur-md mb-6 shadow-lg shadow-red-900/10 scale-90">
                                ...
                                <span className="text-[10px] font-bold tracking-widest uppercase">Secure Access Node</span>
                            </div>
                            ...
                            <p className="text-zinc-400 text-sm font-medium max-w-xs">
                                Enter your credentials to access the emergency response network.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-zinc-500 uppercase tracking-widest ml-1">Email Terminal</label>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center ml-1">
                                        <label className="text-xs font-black text-zinc-500 uppercase tracking-widest">Access Key</label>
                                        <a href="#" className="text-[10px] font-black text-red-600 hover:text-red-400 uppercase tracking-widest transition-colors">Recover</a>
                                    </div>
                                    <div className="relative group">
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-red-600 hover:bg-red-700 text-white font-black h-16 rounded-2xl shadow-[0_0_20px_rgba(220,38,38,0.2)] hover:shadow-[0_0_30px_rgba(220,38,38,0.4)] transition-all transform active:scale-[0.98] border-0 text-md tracking-tighter"
                            >
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">
                                New responder? <Link href="/register" className="text-white hover:text-red-500 transition-colors ml-2 underline decoration-red-600 underline-offset-4">Register in System</Link>
                            </p>
                        </div>
                    </div>
                </div>
